 ...
 * - Dĩ nhiên cứ lưu comment mới vào cuối mảng cũng được, nhưng nay sẽ học cách để thêm phần tử vào đầu mảng
 * trong mongodb.
 ...
 * * Sẽ dùng $push để thêm hoặc $pull để loại bỏ ($pull trong mongodb để lấy một phần tử ra khỏi mảng rồi xóa
 * nó đi)
 */
const updateMembers = async (cardId, incomingMemberInfo) => {
  try {
    ...
    let updateCondition = {}
    if (incomingMemberInfo.action === CARD_MEMBER_ACTIONS.ADD) { // You, 14 seconds ago • Uncommitted cha
